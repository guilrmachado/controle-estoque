...
class ProdutoServiceTest {
    ...
    void deveVenderProdutoComSucesso() {
        ...
        VendaRequest request = new VendaRequest(2);
        ...
        produtoService.vender(1L, request);
    ...
    void deveCriarProdutoComSucesso() {
        ...
        ProdutoModel produtoSalvo = produtoService.salvar(request);

        assertEquals("Notebook", produtoSalvo.getNome());
        assertEquals(100, produtoSalvo.getQuantidadeEmEstoque());
    ...
    void deveLancarExcecaoQuandoEstoqueInsuficiente() {
        VendaRequest request = new VendaRequest(20);
        when(produtoRepository.findById(1L))
                .thenReturn(Optional.of(produto));
